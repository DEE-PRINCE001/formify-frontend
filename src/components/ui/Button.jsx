...
const Button = ({ 
  ...
  const variants = {
    primary: "bg-primary-accent text-primary hover:bg-secondary-accent hover:text-primary-text focus:ring-primary-accent font-bold hover:scale-105",

    secondary: "bg-secondary text-primary-text border border-secondary-hover hover:bg-secondary-hover focus:ring-secondary-text hover:scale-105",
